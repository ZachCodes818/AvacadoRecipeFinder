module.exports.nationalityData = function (name) {
    var data = [
        {
            "num_code": "4",
            "alpha_2_code": "AF",
    ...
    for (var i = 0; i < data.length; i++) {
        if (data[i].en_short_name.toLowerCase() === name.toLowerCase()) {
            return data[i].nationality
        }
    }
    if (name.toLowerCase() === "iranian"){
        return "Persian"
    }
    if (name.toLowerCase() === "america"){
        return "American"
    }
    if (name.toLowerCase() === "asia"){
        return "Asian"
    }
    if (name.toLowerCase() === "africa"){
        return "African"
    }
    if (name.toLowerCase() === "Australia"){
        return "Australian"
    }
    if (name.toLowerCase() === "europe"){
        return "european"
    }
    if (name.toLowerCase() === "south america"){
